...
C_list = [0.01, 0.1, 0.5, 1, 5, 10, 20]
gamma_list = [0.01, 0.1, 0.5, 1, 5, 10, 20]


for c in C_list:
    for gamma in gamma_list:
        clf = SVC(C=c, kernel='rbf', degree=3, gamma=gamma, coef0=0.0,
        ...
        print(r'C:{}, gamma:{}, accuracy score:{}'.format(c, gamma, score))
        plt.scatter(gamma, score)
